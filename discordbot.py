...
async def on_message(message):
    ...
    if message.content == "@🌈Rains☔":
        # チャンネルへメッセージを送信
        await message.channel.send("/tip JPYN 3.9 "f"{message.author.mention}　  :good01:🌈Rains☔Thanks<:JPYNdisco:698471276498649168> ")  # f文字列（フォーマット済み文字列リテラル）

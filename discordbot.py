...
async def on_message(message):
    ...
    if message.content == "sb/sprts":
        ...
        embed.add_field(name="[今日の運勢YourFortune] ",
                        value=random.choice(('☆☆彡超最高☆彡☆【何してもVeryGood!☆勝負に強い日です】','☆最高☆【チームに恵まれた日です。チャレンジしたら幸運を招きます☆彡】', 'よっしゃ！【☆偏見もたずにアルトコイン買ってみたらベリーグッド☆何を買いたい？みんなに聞けば？】', 'やったね☆彡！【納得出来る日でしょう。金運は余り期待出来ないです。】','利益が出る☆彡！【法廷通貨の金運は余り期待出来ないですが！暗号通貨（仮想通貨）において、思わぬ利益が見込めるね☆】'
                                             ,'大吉【☆☆☆自信もって取り組めば必ず好成果となって返ってきます。♡♡♡恋愛運は超ベリグっ】', '小吉【☆BTCホルダー？ホルダーならおもいがけない利益も？あるかもね】', '中吉【☆☆好チャンス！攻めて成果あり。♡♡とりあえず問題なしかな！？】', '小吉【☆☆通常のセオリーを変化させたら好成果となる。♡♡現状から変化ない】'
                                             ,  '末吉【☆☆参加型オンラインゲームで好成果あり♡ゲームばかりじゃダメ。出会いを求めて外にでたら吉あり】', '普通吉【☆暗号通貨に運気が欲しいならば、みんなにレインしたら運気は上昇☂↺】', '吉【☆現状変化なし♡特に変化なし。そのままやっとけ！】', 'ちょい吉【☆と。り。あ。え。ず。って感じ。意味はとりあえずチャレンジしたら吉！】', '吉【☆暗号通貨は小幅利益で売却しないほうがいい。ちなみに恋愛運はなし。そのままぼうっと見とけ！】',  '吉【☆まぁ！適当に！こんなもんよ】'
                                             , 'ごく普通やね【何それ！？と思うだろうがごく普通だ！棚から牡丹餅はない】', '凶【▲儲けようと企んだ事が、やっぱり裏目に出る日だね～。深く考えずに前向きに進もう！これしかないね】'
                                             , '凶【▲残念！好機はないね。負けも勝ちの内かと思え！ファイト】', '大凶【▲▲吐き気するわ！駄目だこりゃ】',  '大凶【▲▲赤字にそなえて安定的備蓄だな！バタバタしない方が吉】', '大大凶【▲▲▲寝るしかない！行動すれば余計に悪化。まず寝る事！】')), inline=False)
